...
**Commercial** Admin Dashboard coded in [Django Framework](https://www.djangoproject.com/) on top of **[StarAdmin Dashboard](https://django-dashboard-staradmin-boxed-pro.appseed.us/login/)** design (PRO Version) designed by **BootstrapDash** Agency - product generated by AppSeed.
...
- License: [Commercial](https://github.com/app-generator/django-dashboard-staradmin-boxed-pro/blob/master/LICENSE.md)
...
- [Django StarAdmin Boxed PRO](https://appseed.us/admin-dashboards/django-dashboard-staradmin-boxed-pro) - Product page
- [Django StarAdmin Boxed PRO](https://django-dashboard-staradmin-boxed-pro.appseed.us/) - LIVE demo

<br />

![Django StarAdmin Boxed PRO - Admin Panel coded in Django.](https://raw.githubusercontent.com/app-generator/django-dashboard-staradmin-boxed-pro/master/media/django-dashboard-staradmin-boxed-pro-intro.gif)

<br />

## Get the source code

- Access the [product page](https://appseed.us/admin-dashboards/django-dashboard-staradmin-boxed-pro) and purchase a **license**
...
- Clone the source code and build the [Django StarAdmin Boxed PRO](https://appseed.us/admin-dashboards/django-dashboard-staradmin-boxed-pro) using the instructions presented in this documentation.
...
> Note: this is a private repository. To get access, you should buy a license from the [product page](https://appseed.us/admin-dashboards/django-dashboard-staradmin-boxed-pro).
...
![Django StarAdmin Boxed PRO - Main Screen.](https://raw.githubusercontent.com/app-generator/django-dashboard-staradmin-boxed-pro/master/media/django-dashboard-staradmin-boxed-pro-screen.png)

<br />

![Django StarAdmin Boxed PRO - Widgets Screen.](https://raw.githubusercontent.com/app-generator/django-dashboard-staradmin-boxed-pro/master/media/django-dashboard-staradmin-boxed-pro-screen-1.png)

<br />

![Django StarAdmin Boxed PRO - Image Gallery.](https://raw.githubusercontent.com/app-generator/django-dashboard-staradmin-boxed-pro/master/media/django-dashboard-staradmin-boxed-pro-screen-4.png)
